	...
	public Object execute(ExecutionEvent event) throws ExecutionException {
		...
		try {
			...
			if(command_name.equals("Proactive"))
			{
				...
				showMessageBox("ExcClipse set to Proactive mode. Your IDE will restart now to apply new settings ...");
			...
			}else if(command_name.equals("Interactive"))
			{
				...
				current_mode=SurfClipseModeManager.current_mode;
				showMessageBox("ExcClipse set to Interactive mode. Your IDE will restart now to apply new settings ...");
				PlatformUI.getWorkbench().restart();
			}
